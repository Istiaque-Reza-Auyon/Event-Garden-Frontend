    ...
    return (
        <div className='flex flex-col bg-[rgb(16,17,19)] h-auto overflow-y-scroll'>
            ...
            <div className='flex flex-col'>
                <EventDescription title='XERXES: 📣 REP YOUR FLAG FESTIVAL🚩' venue='Mehanata Bulgarian Bar' date='Sat, May 18 at 9:00 PM - 4:00 AM' location='113 Ludlow St, New York, NY 10002, USA' attendeeCount='24' description="XERXES MAFIA PRESENTS:
