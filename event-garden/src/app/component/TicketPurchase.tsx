            ...
            <div className='bg-[rgb(16,17,19)] rounded-lg px-1 pb-10 mt-20 '>
                ...
                <div className=''>
                    ...
                    <div key = {index} className='flex justify-between mt-4'>
                        ...
                        <span className='text-[rgb(250,250,252)] pt-5 pl-10'>{`$${ticket.price*ticket.quantity}`}</span>
                    </div>
                )}
                    <div className='flex justify-between mt-2'>
                        <span className='text-[rgb(250,250,252)]  pl-3'>Service Charge</span>
                        <span className='text-[rgb(250,250,252)] '>{`$${Math.round(0.15*totalPrice)}`}</span>
                    </div>
                    <div className='flex justify-between mt-2 border-b-2 border-b-[rgb(134,135,137)] pb-4'>
                        ...
                        <span className='text-[rgb(250,250,252)] '>{`$${Math.round(0.10*totalPrice)}`}</span>
                    </div>
                    <div className='flex justify-between mt-2'>
                        <span className='text-[rgb(250,250,252)]  pl-3'>Total</span>
                        <span className='text-[rgb(250,250,252)] '>{`$${totalPrice}`}</span>
                    </div>
                </div>
                <form id="formId" className='flex flex-col' onSubmit={checkOutHandler}>
                    <div className='flex flex-col p-4 pb-0'>
                        ...
                        <input className='p-3 pl-2 rounded-lg mb-4 ml-1 w-[100%] bg-[rgb(43,44,44)] text-[rgb(134,135,137)] text-[10px] ' name="address1" type="text" placeholder='221b, Baker Street' required />
                    </div>

                    <div className='flex flex-col p-4 pt-0'>
                        <label className=' pl-2 pb-1 text-[rgb(240,242,249)] font-[DM Sans]'>Line 2</label>
                        <input className='p-3 pl-2 rounded-lg mb-4 ml-1 w-[100%] bg-[rgb(43,44,44)] text-[rgb(134,135,137)] text-[10px] ' name="address2" type="text" placeholder='221b, Baker Street' required />
                    </div>

                    <div className='flex flex-col p-4 pt-0 pb-0'>
                        <label className=' pl-2 pb-1 text-[rgb(240,242,249)] font-[DM Sans]'>Card Number</label>
                        <input className='p-3 pl-2 rounded-lg mb-4 ml-1 w-[100%] bg-[rgb(43,44,44)] text-[rgb(134,135,137)] text-[10px] ' name="cardNumber" type="text" placeholder='' required />
                    </div>
                    ...
                    <div className='flex '>
                        <div className='flex flex-col p-4 pt-0 pr-1 w-[50%]'>
                            ...
                            <input className='p-3 pl-2 rounded-lg mb-4 ml-1 w-[100%] bg-[rgb(43,44,44)] text-[rgb(134,135,137)] text-[10px] ' name="expiration" type="text" placeholder='' required />
                        </div>
                        <div className='flex flex-col p-4 pt-0 pl-1 w-[50%]'>
                            <label className=' pl-2 pb-1 text-[rgb(240,242,249)] font-[DM Sans]'>CVC</label>
                            <input className='p-3 pl-2 rounded-lg mb-4 ml-1 w-[100%] bg-[rgb(43,44,44)] text-[rgb(134,135,137)] text-[10px] ' name="CVC" type="text" placeholder='' required />
                        </div>
                    </div>
                    <button className='flex justify-center items-center p-2 bg-[rgb(233,186,0)] text-black mt-5 rounded-[50px] w-[100%] ' type='submit'>Checkout</button>
                </form>
                {  credentialValid === 0 ? <></> 
