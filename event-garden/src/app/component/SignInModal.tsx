...
const SignInModal: React.FC<SignInModalProps> = ({ setTokenStatus, toggleMenu, setShow, orgList, allocateOrg }) => {
    ...
    return (
        <div className='fixed z-10 '>
            <div><button className='bg-white rounded-full mt-[20vh] absolute z-20 ' onClick={toggleMenu}><CiCircleRemove size={24} /></button></div>
            <div className='flex flex-col w-[90vw] mt-[20vh] bg-[rgb(5,6,6)] border-2px border-white absolute z-10 rounded-lg border-2 '>
