...
const NavBar:React.FC<NavBarProps> = ({toggleMenu}) => {
    ...
    <div className='flex'><GiVineLeaf style={{color:'yellow'}} className="text-4xl mr-2 mt-1"/><span className='text-[rgb(255,204,0)] text-2xl mt-1 font-[DM Sans]'>Event Garden</span></div>
